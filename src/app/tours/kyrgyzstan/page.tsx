            ...
            <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-end pt-32 pb-64 lg:pb-40">
              <div className="max-w-4xl">
                <div className="flex flex-wrap gap-3 mb-6">
                  <span className="bg-accent text-accent-foreground px-4 py-1.5 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider">8 Nights / 9 Days</span>
                ...
                <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl leading-relaxed font-light">
                  Step into the wild, untouched landscapes of Central Asia with the Kyrgyzstan Self-Drive Adventure — an 8-night expedition where every road leads to discovery.
                </p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between py-6 md:py-4 gap-4">
                  <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-white font-bold text-lg tracking-tight">June 18, 2026</p>
                    </div>
                  </div>

...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <Header />
      <main>
        <section id="hero-section" className="relative w-full overflow-hidden h-[85vh] md:h-screen">
            {/* Video for desktop */}
            ...
            <div className="relative z-10 h-full flex flex-col justify-end md:justify-center pt-24 box-border">
